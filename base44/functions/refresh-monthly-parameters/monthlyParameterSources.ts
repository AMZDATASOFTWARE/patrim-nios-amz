...
function buildOfficialPagePrompt(
  ...
  return [
    ...
    'Valores numericos devem ser brutos em suggested_value: 10 para 10%, 1000.5 para moeda. Nunca retorne "10%", "R$ 1.000,00" ou "5 anos" como valor numerico.',
    ...
    '{"items":[{"category":"","field_name":"","suggested_value":"","value_type":"text","unit":"","source_name":"","source_url":"","reason":"","confidence_level":"medium","warnings":[]}],"warnings":[]}',
    '',
...
function normalizeOfficialPageRows(
  ...
  return items.map((item) => ({
    ...
    value: item.suggested_value ?? item.value,
      ...
      properties: {
        items: {
          ...
          items: {
            ...
            required: ['field_name', 'suggested_value', 'value_type'],
          },
        },
        warnings: { type: 'array', items: { type: 'string' } },
      },
